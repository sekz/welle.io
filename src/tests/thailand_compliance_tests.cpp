...
bool ThailandComplianceTests::testThaiCharacterSet() {
    ...
    const char thai_text[] = {0xE0, 0xB8, 0xAA, 0xE0, 0xB8, 0xA7, 0xE0, 0xB8, 0xB1, 0xE0, 0xB8, 0xAA, 0xE0, 0xB8, 0x94, 0xE0, 0xB8, 0xB5, 0x00}; // "สวัสดี" in UTF-8
    
    std::string result = toUtf8StringUsingCharset(thai_text, CharacterSet::ThaiProfile, strlen(thai_text));
